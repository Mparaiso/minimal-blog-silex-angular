...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/create", {templateUrl: "post-create.html", controller: "PostCreateCtrl"})
    $routeProvider.when("/:postId", {templateUrl: "post-read.html", controller: "PostReadCtrl"})
